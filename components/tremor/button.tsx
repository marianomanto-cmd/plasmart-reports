...
// Fuente: tremorlabs/tremor — src/components/Button/Button.tsx (copy-paste textual).
// Único cambio: imports de cx/focusRing apuntan a "@/lib/tremor/*".
...
import { focusRing } from "@/lib/tremor/focus-ring";
