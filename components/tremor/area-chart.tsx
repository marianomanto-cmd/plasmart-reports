...
// Fuente: tremorlabs/tremor — src/components/AreaChart/AreaChart.tsx (copy-paste textual).
// Único cambio: imports de cx/chart-colors/utils/hook apuntan a "@/lib/tremor/*".
...
import { useOnWindowResize } from "@/lib/tremor/use-on-window-resize"
import {
  AvailableChartColors,
  type AvailableChartColorsKeys,
  constructCategoryColors,
  getColorClassName,
} from "@/lib/tremor/chart-colors"
import { cx } from "@/lib/tremor/cx"
import { getYAxisDomain } from "@/lib/tremor/get-y-axis-domain"
import { hasOnlyOneValueForKey } from "@/lib/tremor/has-only-one-value-for-key"
...
// Plasmart: Recharts 3.x amplió `label` a `string | number | undefined`.
// Tremor upstream tipa `label: string` y rompe con strict TS. Reescribimos
// el Pick para ampliarlo localmente sin tocar el resto del componente.
...
interface ChartTooltipProps {
  ...
  payload: PayloadItem[]
  // Plasmart: ampliado para Recharts 3.x (ver TooltipProps arriba).
