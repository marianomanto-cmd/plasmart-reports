...
export const FALLBACK_CONTEXT: AnalysisContext = {
  ...
  tracking:
    "Cuentas activas: Google Ads, Meta Ads, GA4 (tráfico web). El objetivo del sitio es generar consultas por WhatsApp. En Meta las campañas optimizan para mensajería: la métrica 'conversiones' son conversaciones de mensajería iniciadas (consultas, sumando todas las plataformas de mensajería — WhatsApp + Messenger + Instagram Direct), NO conversiones de píxel/web. Por eso el CPA de Meta es 'costo por consulta'. Las campañas de Meta con objetivo de alcance/awareness muestran 0 conversiones por diseño: evaluarlas por alcance, CPM y CTR, no por conversiones. En Google Ads, 'conversiones' es un proxy: Google no ve la conversación de WhatsApp (pasa fuera de Google), a lo sumo cuenta el clic al botón, así que sobre-cuenta respecto de las consultas reales. Las conversiones de Google Ads y Meta NO son la misma unidad: no compararlas 1:1. Además el valor de conversión de Google suele ser un valor sintético asignado, así que el ROAS de GAds no es facturación real.",
  focus: "",
  decision: "",
  businessContext: "",
  scope: "",
